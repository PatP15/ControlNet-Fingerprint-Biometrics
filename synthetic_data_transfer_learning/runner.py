...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data/puma_envs/FingerPrintMatchingModels/test_embeddings_printsgan.pth',
    ...
    parser.add_argument('--output_folder', type=str, default='/data/puma_envs/FingerPrintMatchingModels/test_pretrain_results',
