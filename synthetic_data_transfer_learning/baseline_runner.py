...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data/puma_envs/FingerPrintMatchingModels/baseline/model_embeddings_baseline.pth',
    ...
    parser.add_argument('--output_folder', type=str, default='/data/puma_envs/FingerPrintMatchingModels/baseline/baseline_pretrain_results',
    ...
    batch_size=64
    #0.8, 0.1, 0.1 split
    training_dataset = TripletDataset(PrintsGANDataset(os.path.join(args.data_path, 'train'), 50000, 100, train=True))
    ...
    val_dataset = TripletDataset(PrintsGANDataset(os.path.join(args.data_path, 'val'), 10000, 100, train=False))
