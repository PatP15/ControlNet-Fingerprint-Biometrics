...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data/puma_envs/FingerPrintMatchingModels/imagenet/finetune_embeddings_imagenet.pth',
    ...
    parser.add_argument('--output_folder', type=str, default='/data/puma_envs/FingerPrintMatchingModels/imagenet/finetune_imagenet_results',
    ...
    # model_path = '/data/puma_envs/FingerPrintMatchingModels/model_embeddings_printsgan.pth'
