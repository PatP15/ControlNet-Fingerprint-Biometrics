...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/data/puma_envs/FingerPrintMatchingModels/finetune_embeddings_printsgan2.pth',
    ...
    parser.add_argument('--output_folder', type=str, default='/data/puma_envs/FingerPrintMatchingModels/finetune_printsgan_results2',
    ...
    model_path = '/data/puma_envs/FingerPrintMatchingModels/model_embeddings_printsgan2.pth'
