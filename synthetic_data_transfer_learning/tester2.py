...
SD302_PATH = '/home/puma/sd302_split'
...
test_dataset = TripletDataset(FingerprintDataset(os.path.join(SD302_PATH, 'test'), train=False))
...
def run_test(MODEL_PATH, iteration):
    ...
    print(model_name)
    output_dir = '/home/puma/results2'
    dataset_name = "SD302/test"
    ...
    with open(f'/home/puma/results2/{model_name}_iteration_{iteration}.txt', 'w') as fout:
