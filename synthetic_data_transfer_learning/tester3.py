...
MODELS = [#'../FingerPrintMatchingModels/diffusion/finetune_embeddings_diffusion2.pth', 
          '../FingerPrintMatchingModels/finetune_embeddings_printsgan_all.pth',
...
SD300_PATH = '/home/puma/sd300a_split'
...
test_dataset = TripletDataset(FingerprintDataset(os.path.join(SD300_PATH, 'train'), train=False))
...
def run_test(MODEL_PATH, iteration):
    test_dataset = TripletDataset(FingerprintDataset(os.path.join(SD300_PATH, 'test'), train=False))
    test_dataloader = DataLoader(test_dataset, batch_size=batch_size, shuffle=True)
    ...
    print(model_name)
    output_dir = '/home/puma/results3'
    dataset_name = "SD300/test"
    ...
    with open(f'/home/puma/results3/{model_name}_iteration_{iteration}.txt', 'w') as fout:
